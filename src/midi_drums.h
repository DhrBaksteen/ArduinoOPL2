 ...
 */
	...
	const unsigned char DRUMINS_SNARE_AC[12]  PROGMEM = { 0x00, 0x24, 0x00, 0xFF, 0x0F, 0x0F, 0x00, 0x02, 0x00, 0xF7, 0xA9, 0x00 };
	const unsigned char DRUMINS_CLAP[12]      PROGMEM = { 0x00, 0x3E, 0x00, 0x9F, 0x0F, 0x0F, 0x00, 0x30, 0x00, 0x87, 0xFA, 0x00 };
	const unsigned char DRUMINS_SNARE_EL[12]  PROGMEM = { 0x00, 0x24, 0x00, 0xFF, 0x0F, 0x0F, 0x00, 0x02, 0x00, 0xF7, 0xA9, 0x00 };
	...
	const unsigned char DRUMINS_CRASH[12]     PROGMEM = { 0x00, 0x2C, 0x00, 0x9F, 0x0F, 0x0F, 0x02, 0x0E, 0x05, 0xC5, 0xD4, 0x03 };
	const unsigned char DRUMINS_TOM_HIGH[12]  PROGMEM = { 0x00, 0x06, 0x0A, 0xFA, 0x1F, 0x0C, 0x00, 0x11, 0x00, 0xF5, 0xF5, 0x00 };
	const unsigned char DRUMINS_RIDE_CY[12]   PROGMEM = { 0x00, 0x29, 0x10, 0x94, 0x0F, 0x0F, 0x00, 0x04, 0x04, 0xF9, 0x44, 0x03 };
	const unsigned char DRUMINS_TAMBOUR[12]   PROGMEM = { 0x00, 0x2C, 0x00, 0x9F, 0x0F, 0x0F, 0x02, 0x0E, 0x05, 0xC5, 0xD4, 0x03 };
	const unsigned char DRUMINS_CYMBAL[12]    PROGMEM = { 0x00, 0x29, 0x10, 0x94, 0x0F, 0x0F, 0x00, 0x04, 0x04, 0xF9, 0x44, 0x03 };
	const unsigned char DRUMINS_TAMBOU2[12]   PROGMEM = { 0x00, 0x2E, 0x09, 0xF5, 0xF1, 0x01, 0x00, 0x06, 0x03, 0x87, 0xF7, 0x03 };
	const unsigned char DRUMINS_SPLASH[12]    PROGMEM = { 0x00, 0x2C, 0x00, 0x9F, 0x0F, 0x0F, 0x02, 0x0E, 0x05, 0xC5, 0xD4, 0x03 };
	const unsigned char DRUMINS_COWBELL[12]   PROGMEM = { 0x00, 0x37, 0x14, 0xF7, 0xA1, 0x09, 0x01, 0x03, 0x00, 0xF6, 0x28, 0x00 };
	const unsigned char DRUMINS_CRASH2[12]    PROGMEM = { 0x00, 0x2C, 0x00, 0x9F, 0x0F, 0x0F, 0x02, 0x0E, 0x05, 0xC5, 0xD4, 0x03 };
	const unsigned char DRUMINS_VIBRASLA[12]  PROGMEM = { 0x00, 0x80, 0x00, 0xFF, 0x0F, 0x0D, 0x01, 0x00, 0x00, 0xF5, 0xF7, 0x01 };
	const unsigned char DRUMINS_RIDE2[12]     PROGMEM = { 0x00, 0x29, 0x10, 0x94, 0x0F, 0x0F, 0x00, 0x04, 0x04, 0xF9, 0x44, 0x03 };
	...
	const unsigned char DRUMINS_TRIANGL1[12]  PROGMEM = { 0x00, 0x26, 0x44, 0xF1, 0xFF, 0x07, 0x00, 0x27, 0x40, 0xF5, 0xF5, 0x00 };
	const unsigned char DRUMINS_TRIANGL2[12]  PROGMEM = { 0x00, 0x26, 0x44, 0xF1, 0xFF, 0x07, 0x00, 0x27, 0x40, 0xF5, 0xF5, 0x00 };
